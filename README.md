...
Во время кодирования в любой момент можно нажать Ctrl+C. Процесс кодирования остановится, но результаты не будут потеряны и 
в результирующий файл запишется вся перекодированная информация.