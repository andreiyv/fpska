...
if "!method!"=="slow" (
echo "slow"
%cd%\mencoder\mencoder.exe %cd%\scripts\work.avs -oac copy -ovc x264 -x264encopts preset=veryslow:tune=film:crf=9:fast_pskip=0:threads=auto -o %cd%\60fps_video.mp4
) else if "!method!"=="fast" (
echo "fast"
